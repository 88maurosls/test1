...
def main():
    ...
    barcode_input = st.text_input('Inserire il barcode', key='barcode_input', on_change=check_barcode, args=(st.session_state.barcode_input, df))

    if st.button('Check'):
        check_barcode(st.session_state.barcode_input, df)
